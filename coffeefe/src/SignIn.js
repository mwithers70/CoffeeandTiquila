...
//                     <h1>Coffee and Tiquila</h1></div>
//
//                 {/*<form className="form-signin" th:action="@{/coffeeshops}" method="post">*/}
//                 <form>
...
//                                         style="width: 96%; margin-right: 3%; flex-grow: 0.45; background: #40e0d0">Sign
//                                     In
//                                 </button>
//                             </form>
//                         </div>
...
//                                 <button className="btn btn-sm " name="Submit" type="Submit"
//                                         style="width: 96%; margin-left: 3%; flex-grow: 0.45; background: #40e0d0">Sign
//                                     Up
//                                 </button>
//                             </form>
//                         </div>
